...
// Define available categories for transactions
const CATEGORIES = [
...
// Screen component for creating a new transaction
const CreateScreen = () => {
    ...
    const handleCreateTransaction = async () => {
        ...
        if (!amount || isNaN(parseFloat(amount)) || parseFloat(amount) <= 0) { // validate amount
           Alert.alert("Error", "Please enter a valid amount");
           return;
        }   
        
        if (!selectedCategory) { // validate category
        ...
        try { 
            ...
            const response = await fetch(`${API_URL}/transactions`, { // create transaction endpoint
                method: "POST",
                headers: { 
